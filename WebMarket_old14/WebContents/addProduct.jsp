...
<div class="container">
	...
	<form name="newProduct" action="./processAddProduct.jsp" class="form-horizontal" method="post" enctype="multipart/form-data">
		...
		<div class="form-group row">
			...
			<div class="col-sm-3">
			<%-- 페이지 출력시 name태그에 자동으로 커서이동처리 - autofocus() --%>
		...
		<%
			PreparedStatement pstmt = conn.prepareStatement("select p_manufacturer, name from manufacturer");
		...
		<div class="form-group row">
			...
			<div class="col-sm-5">
				...
				<input type="radio" name="condition" value="Refurbished "><fmt:message key="condition_Refurbish"/>
			</div>
		</div>
		<div class="form-group row">
